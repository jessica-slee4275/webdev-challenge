<script>
    ...
    function displayContents(contents) {
        ...
        document.getElementById("demo").value = contents;
    }
...
<?php 
    $allContent = "";
    $importedText = isset($_POST['btn_new_file_generate']) ? $_POST['btn_new_file_generate'] : false;
    // if ($importedText) 
    // {
    //     $allContent = htmlentities($_POST['imported_data'], ENT_QUOTES, "UTF-8");
    //     //check selected file
    //     //echo $allContent;
    // } else {
    ...
    function btn_new_file_generate() { 
        ...
        echo "Please click the \"Generate with Default File\" button.";
    } 
?>